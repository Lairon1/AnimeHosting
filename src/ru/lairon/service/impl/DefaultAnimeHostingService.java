 ...
 */
package ru.lairon.service.impl;
...
public class DefaultAnimeHostingService implements AnimeHostingService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAnimeHostingService.class);
	...
	{
		return DefaultAnimeHostingService.class.getResourceAsStream("/AnimeHosting/sap-hybris-platform.png");
	}
