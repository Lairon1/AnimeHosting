...
<html lang="en">
<head>
    <title>Welcome to AnimeHosting</title>
    <link rel="stylesheet" href="<c:url value="/static/AnimeHosting-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "AnimeHosting" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/AnimeHosting-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/AnimeHosting-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/AnimeHosting-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/AnimeHosting-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/AnimeHosting-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
